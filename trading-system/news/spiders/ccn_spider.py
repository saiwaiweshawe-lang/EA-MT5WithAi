...
class CCNSpider(BaseSpider):
    CCN_SOURCES = {
        "ccn": {
            "name": "CCN",
            "rss_url": "https://www.cryptonews.com/feed",
            "html_url": "https://www.cryptonews.com/",
        },
    }
    ...
    def fetch_news(self, keywords: List[str], limit: int = 10) -> List[NewsItem]:
        ...
        return self._fetch_source("ccn", self.CCN_SOURCES["ccn"],
    ...
    def _fetch_source(self, source_id: str, source: Dict,
        ...
        try:
            ...
            logger.info(f"CCN: fetched {len(news_items)} items")
            return news_items
            ...
            logger.warning(f"CCN fetch failed: {e}")
            return []
