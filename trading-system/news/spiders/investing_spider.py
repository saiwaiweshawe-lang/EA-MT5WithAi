...
class InvestingSpider(BaseSpider):
    INVESTING_SOURCES = {
        "investing": {
            ...
            "html_url": "https://www.investing.com/news/",
        },
    }
    ...
    def fetch_news(self, keywords: List[str], limit: int = 10) -> List[NewsItem]:
        ...
        return self._fetch_source("investing", self.INVESTING_SOURCES["investing"],
    ...
    def _fetch_source(self, source_id: str, source: Dict,
        ...
        try:
            ...
            logger.info(f"Investing.com: fetched {len(news_items)} items")
            return news_items
