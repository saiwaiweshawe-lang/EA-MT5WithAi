...
class BitcoinistSpider(BaseSpider):
    BITCOINIST_SOURCES = {
        "bitcoinist": {
            "name": "Bitcoinist",
            "rss_url": "https://bitcoinist.com/feed/",
            "html_url": "https://bitcoinist.com/",
        },
    }
    ...
    def fetch_news(self, keywords: List[str], limit: int = 10) -> List[NewsItem]:
        ...
        return self._fetch_source("bitcoinist", self.BITCOINIST_SOURCES["bitcoinist"],
    ...
    def _fetch_source(self, source_id: str, source: Dict,
        ...
        try:
            ...
            logger.info(f"Bitcoinist: fetched {len(news_items)} items")
            return news_items
            ...
            logger.warning(f"Bitcoinist fetch failed: {e}")
            return []
